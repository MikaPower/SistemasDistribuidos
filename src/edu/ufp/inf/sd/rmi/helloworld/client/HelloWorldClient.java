...
public class HelloWorldClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            ...
            HelloWorldClient hwc = new HelloWorldClient(args);
            //2. ============ Lookup service ============
            hwc.lookupService();
            //3. ============ Play with service ============
            hwc.playService();
    ...
    public HelloWorldClient(String args[]) {
        try {
            //List ans set args
            printArgs(args);
            ...
            Logger.getLogger(HelloWorldClient.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    private Remote lookupService() {
        try {
            ...
            if (registry != null) {
                ...
                helloWorldRI = (HelloWorldRI) registry.lookup(serviceUrl);
            } else {
