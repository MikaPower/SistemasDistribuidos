...
@Set JDK=C:\Program Files\Java\jdk1.8.0_111
@REM These vars will be used to check the output folder (whereto classes are generated)
@Set CURRENT_IDE=IntelliJ

@REM ==== JAVA NAMING STUFF ====
@Set JAVAPROJ_NAME=SistemasDistribuidos
@set JAVAPROJ=C:\\Users\\nunoalfhotmail.com\\IdeaProjects\\SistemasDistribuidos

@Set PACKAGE=quiz
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=QuizService
@Set CLIENT_CLASS_PREFIX=Quiz
@Set SERVER_CLASS_PREFIX=Quiz
